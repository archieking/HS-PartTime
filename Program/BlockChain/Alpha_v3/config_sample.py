...
strategy_list = [
                    {
                        ...
                        "factor_list": [
                            ('暴力多1空1因子', False, n, 1)  # 因子名（和factors文件中相同），排序方式，参数，权重。
                        ],
                        "long_filter_list": [
                    ...
                    for n in [_ for _ in range(60, 141, 10)]  # 参数覆盖从60到140
                ] + [
                    {
                        "strategy": "Strategy_Base",
                        "offset_list": [0],
                        "hold_period": "1H",
                        "is_use_spot": True,
                        "long_select_coin_num": 40,
                        "short_select_coin_num": 40,
                        "cap_weight": 1,
                        "long_cap_weight": 1,  # 多头资金占比
                        "short_cap_weight": 1,  # 空头资金占比
                        "factor_list": [
                            ('现货合约因子多40空40', False, n, 1)  # 因子名（和factors文件中相同），排序方式，参数，权重。
                        ],
                        "long_filter_list": [
                        ],
                        "short_filter_list": [
                ...
                ] + [
                    {
                        ...
                        "short_cap_weight": 1,  # 空头资金占比
                        "factor_list": [
                            ('纯合约因子多40空40', False, n, 1)  # 因子名（和factors文件中相同），排序方式，参数，权重。
                        ],
                        "long_filter_list": [
                        ],
                        "short_filter_list": [
...
factor_param_range_dict = {
    '遍历因子名称': [_ for _ in range(10, 201, 10)],
}
